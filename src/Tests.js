...
class Tests extends Component {
  ...
  async componentDidMount() {
    ...
    const getProject = await getProjectInfo(user.id, '1370b0a7-6049-455a-aad8-0a4880648097')
    ...
    // console.log('currentProjects >>>', currentprojects.length)
    ...
    // const changeProjectNotes = await editProjectNotes(user.id, '1370b0a7-6049-455a-aad8-0a4880648097', 'HEY CHECK NOTES')
